...
var addressFieldDrtv = function($compile) {
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            element.html('<div class="addressField__wrapper"><div class=\"col-xs-11 less-paddings-mobile\">\n \
                    <label translate=\"' + labelTranslated + '\"></label>\n \
                    <input ng-model="tx.to" class=\"form-control address-field\" type=\"text\" placeholder=\"' + placeholder + '\" ng-model=\"addressDrtv.ensAddressField\" ng-disabled=\"addressDrtv.readOnly\" ng-class=\"Validator.isValidENSorEtherAddress(' + varName + ') ? \'is-valid\' : \'is-invalid\'\"/>\n \
                ...
                <div class=\"col-xs-1 address-identicon-container\">\n \
                   <div class=\"addressIdenticon margin-top\" title=\"Address Indenticon\" blockie-address=\"{{' + varName + '}}\" watch-var=\"' + varName + '\"></div>\n \
                </div></div>');
