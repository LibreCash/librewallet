'use strict';
var swapCtrl = function ($scope, $sce, walletService, libreService) {
  ...
  */
  ...
  $scope.sendKyberTx = async function (signedTx) {
    try {
      ...
      let error = e.error || e,
          metamaskError = await libreService.methods.checkMetamaskError(translator, error);
      $scope.notifier.danger(metamaskError || "Swap tx sending: " + error, 0);
      console.error(e);
    }
  };
