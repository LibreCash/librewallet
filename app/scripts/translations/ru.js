...
x_CancelTx                  : 'Отменить транзакцию',
x_PasswordDesc              : 'Этот пароль * шифрует * ваш приватный ключ.  Этот пароль не служит для генерации вашего ключа. **Для разблокировки вашего кошелька необходимы как приватный ключ, так и пароль.**',
...
/* Gen Wallet Updates */
GEN_Help_1                  : 'Используйте ваш',
GEN_Help_2                  : 'для доступа к кошельку.',
GEN_Help_3                  : 'Ваше устройство * это * ваш кошелек.',
GEN_Help_4                  : 'Инструкции & FAQ',
GEN_Help_5                  : 'Как создать кошелек',
GEN_Help_6                  : 'Быстрый старт',
GEN_Help_7                  : 'Храните его в безопасном месте · Сделайте резервную копию · Не передавайте никому · Не теряйте · Он не может быть восстановлен в случае утери',
...
x_AddessDesc                : 'Адрес это "номер счёта" или "открытый ключ". Вы сообщаете этот адрес людям, чтобы они могли отправлять Вам ETH. Картинка позволяет легко опознать Ваш адрес среди других адресов. ',
x_Address                   : 'Ваш адрес ',
x_Cancel                    : 'Отменить ',
...
ADD_Radio_2                 : 'Выбрать файл',
ADD_Radio_2_alt             : 'Выбрать файл',
ADD_Radio_2_short           : 'ВЫБРАТЬ ФАЙЛ',
ADD_Radio_3                 : 'Введите ваш закрытый ключ ',
ADD_Radio_4                 : 'Добавить счёт в список слежения ',
ADD_Radio_5                 : 'Скопируйте или введите кодовую фразу ',
ADD_Radio_5_Path            : 'Выберите HD ',
ADD_Radio_5_woTrezor        : '(Jaxx, Metamask, Exodus, imToken)',
ADD_Radio_5_withTrezor      : '(Jaxx, Metamask, Exodus, imToken, TREZOR)',
ADD_Radio_5_PathAlternative : '(Ledger)',
ADD_Radio_5_PathTrezor      : '(TREZOR)',
ADD_Radio_5_PathCustom      : '(Собственный) ',
...
ADD_Label_8                 : 'Пароль (опционально): ',
...
SEND_custom                 : 'Другое ',
SEND_gas                    : 'Газ ',
SEND_TransferTotal          : 'Перевести весь баланс ', // updated to be shorter
...
SENDModal_No                : 'Нет, отменить',
SENDModal_Yes               : 'Да, согласен',
...
MYWAL_Content_3             : 'Если Вы планируете в будущем использовать этот кошелёк в LibreBank CX, Вам надо будет вручную заново добавить его, указав закрытый ключ или файл JSON и пароль. ',

VAR_tokenAddress            :  'Адрес LibreCash',
VAR_cryptoFiatRate          :  'Номинальный курс',
VAR_buyRate                 :  'Курс покупки',
VAR_sellRate                :  'Курс продажи',
VAR_buyFee                  :  'Комиссия (покупка)',
VAR_sellFee                 :  'Комиссия (продажа)',
VAR_countOracles            :  'Количество оракулов',
VAR_requestPrice            :  'Стоимость запроса',
VAR_contractState           :  'Состояние контракта',
VAR_requestTime             :  'Курс запрошен',
VAR_calcTime                :  'Курс рассчитан',
VAR_tokenBalance            :  'Баланс контракта',
...
NODE_Warning                : 'Ваш узел должен использовать протокол HTTPS, чтобы LibreBank.com мог с ним работать. Вы можете [скачать репозиторий LibreBank & и запустить его локально](https://github.com/kvhnuke/etherwallet/releases/latest) чтобы иметь возможность работать с любыми узлами, или получите бесплатный SSL сертификат на [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Имя узла',
NODE_Port                   : 'Порт узла',
...
ADD_Ledger_0a               : 'Перезапустите LibreBank через безопасное (SSL) соединение ',
ADD_Ledger_0b               : 'Перезапустите LibreBank с браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
ADD_Ledger_scan             : 'Подключиться к Ledger ',

ADD_MetaMask                : 'Подключиться',
...
ADD_DigitalBitbox_0a        : 'Перезапустите LibreBank через безопасное (SSL) соединение ',
ADD_DigitalBitbox_0b        : 'Перезапустите LibreBank с браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
ADD_DigitalBitbox_scan      : 'Подключиться ',
...
ERROR_7                     : 'Некорректная сумма. (Число от 0 до 18.) ', // 7
ERROR_8                     : 'Некорректно указан лимит газа. (Число, например 21000-4000000.) ', // 8
ERROR_9                     : 'Недопустимые данные. (Must be hex.) ', // 9
ERROR_10                    : 'Некорректно указано количество газа. (Число, например 20 GWEI / 20000000000 WEI.) ',
ERROR_11                    : 'Неверный номер перевода (nonce). (число.) ', // 11
...
SUCCESS_3                   : 'Транзакция отправлена в сеть. Это не означает, что она была обработана и отправлена. Сохраните хэш транзакции для проверки:    ',
...
TranslatorName_1            : '[Михаил Владимиров](https://www.LibreBank.com/?gaslimit=21000&to=0x6ff323e36bfdb20502b23780695f4e77e36cde95&value=1.0#send-transaction) ',
...
HELP_0_Title                : '0) Я новичок. Что я могу делать? ',
...
HELP_0_Desc_2               : 'Создать новый кошелек',
...
HELP_1_Title                : '1) Как создать новый кошелек? ',
HELP_1_Desc_1               : 'Перейдите на вкладку "Создать кошелек". ',
...
// LibreBank Append Here
NAV_Exchange                : 'Обмен ',
NAV_SellLibre               : 'Продать LibreCash',
NAV_MyOrders                : 'Мои ордера',
LIBRESTATUS_allowed         : 'Обмен разрешен',
LIBRESTATUS_status          : 'Статус контракта',
LIBRESTATUS_lastUpdate      : 'Запрос курсов',
LIBRESTATUS_queuePeriod     : 'Время на обработку очереди',
LIBRESTATUS_seconds         : 'секунды',
LIBRESTATUS_errorStatus     : 'Ошибка получения статуса контракта',
LIBRESTATUS_errorVar        : 'Ошибка получения перемннной контракта',
LIBRE_checkLegit            : 'Пожалуйста, сверьте адреса контрактов',
LIBRE_sellTokens            :  'Продать токенов: ',
LIBRE_sellAllApproved       : 'Продать все токены',
LIBRE_exchangeLibreCash     : 'Обмен LibreCash',
LIBRE_sellRate              : 'Курс продажи',
LIBRE_buyRate               : 'Курс покупки',
LIBRE_tokenBalance          : 'Баланс',
LIBRE_allowed               : 'Доступно к трате',
LIBRE_allTokens             : 'Все токены',
LIBRE_needApprove           : 'Вы должны выдать права на трату перед продажей',
LIBRE_rateProcessing        : 'Получение курсов от оракулов...',
LIBRE_oraclesReceived       : 'оракул(ов) получили данные',
LIBRE_timeout               : 'Таймаут',
LIBRE_remains               : 'осталось',
LIBRE_days                  :  'дня (дней)',
LIBRE_calculatingPossible   : 'Расчет курса возможен когда',
LIBRE_calculatingPossible1  : 'все данные оракулов актуальны',
LIBRE_calculatingPossible2  : 'или таймаут вышел и как минимум',
LIBRE_calculatingPossible3  : 'оракула(ов) имеют актуальные данные',
LIBRE_oraclesActual         : 'Оракулы имеют актуальные данные. Запустите расчет курса для покупки и продажи',
LIBRE_oraclesActual1        : 'оракула(ов) имеют актуальные данные. Данные актуальны 10 минут',
LIBRE_oraclesActual2        : 'Необходимо минимум',
LIBRE_oraclesActual3        : 'актуальных оракулов для расчета курса',
LIBRE_deadline1             : 'Время до конца работы контракта',
LIBRE_deadline2             : '',
LIBRE_allowance             : 'Одобрено к трате',
LIBRE_approve               : 'Выдать право',
LIBRE_approve0              : 'Отозвать право',
LIBRE_balance               : 'Баланс',
LIBRE_approveAll            : 'Выдать право на весь баланс',
LIBRE_sell                  : 'Продать',
LIBRE_buy                   : 'Купить',
LIBRE_buyDirection          : 'ETH -> Libre',
LIBRE_sellDirection         : 'Libre -> ETH',
LIBRE_noTokens              : 'Нет токенов на балансе',
LIBRE_contracts             : 'Контракты',
LIBRE_withdraw              : 'Вывести баланс',
LIBRE_getEther              : 'ETH доступно',
LIBRE_txPending             : 'Обрабатывается...',
LIBRE_orderID               : '№',
LIBRE_orderType             : 'Тип',
LIBRE_orderRecipient        : 'Получатель',
LIBRE_orderAmount           : 'Объем',
LIBRE_orderTimestamp        : 'Дата',
LIBRE_orderLimit            : 'Ограничение курса',
LIBRE_orderNoOrders         : 'У вас нет открытых ордеров',
LIBRE_nullWallet            : 'Вы не авторизованы в кошельке',
LIBRE_stateLOCKED           : 'Заблокирован',
LIBRE_statePROCESSING_ORDERS: 'Обработка ордеров',
...
LIBREALLOWANCE_txFail       : 'Ошибка при выдаче прав на трату',
LIBRESELL_txOk              : 'Продажа токенов успешно обработана',
LIBRESELL_txFail            : 'Ошибка при продаже токенов',
LIBREWITHDRAW_txOk          : 'Транзакция вывода баланса успешно обработана',
LIBREWITHDRAW_txFail        : 'Ошибка при выводе баланса',
LIBREBUY_txOk               : 'Покупка токенов успешно обработана',
LIBREBUY_txFail             : 'Ошибка при покупке токенов',
LIBRERUR_txOk               : 'Запрос данных оракулов успешно обработан',
LIBRERUR_txFail             : 'Ошибка при запросе данных оракулов',
LIBRECR_txOk                : 'Курсы успешно рассчитаны',
LIBRECR_txFail              : 'Ошибка при расчете курсов',
LIBREPBUY_txOk              : 'Очередь на покупку успешно обработана',
LIBREPBUY_txFail            : 'Ошибка при обработке очереди на покупку',
LIBREPSELL_txOk             : 'Очередь на продажу успешно обработана',
LIBREPSELL_txFail           : 'Ошибка при обработке очереди на продажу',
LIBRESEND_txOk              : 'Перевод удался',
LIBRESEND_txFail            : 'Перевод не удался',
LIBRE_possibleError         : 'Неизвестная ошибка при работе с контрактом',
LIBRE_gettingDataError      : 'Ошибка получения данных контракта',
LIBRE_orderNotAllowed       : 'Создание ордеров недоступно. Проверьте статус контракта',
LIBRE_RURNotAllowed         : 'Запрос курсов недоступен',
LIBRE_CRNotAllowed          : 'Расчет курсов недоступен',
LIBRE_QueueNotAllowed       : 'Обработка курсов недоступна сейчас',
LIBRE_bankPaused            : 'Контракт находится в состоянии паузы',
LIBREBUY_networkFail        : 'Контракт доступен только в сети Rinkeby и основной сети',
LIBRE_forceEmission         : 'Эмиссия и ремиссия',
LIBREFORCE_RUR              : 'Обновить курсы',
LIBREFORCE_CR               : 'Рассчитать курсы',
LIBREFORCE_PBUY             : 'Число ордеров для обработки (макс. 5)',
LIBREFORCE_PSELL            : 'Число ордеров для обработки (макс. 5)',
LIBREFE_LBStatus            : 'Статус контракта',
LIBREFE_LastBlockTime       : 'Время последнего блока',
LIBREFE_LastUpdate          : 'Время обновления',
LIBREFE_RelevancePeriod     : 'Период актуальности курса',
...
LIBRE_modalETHToSend            :  'ETH к отправке:',
LIBRE_modalAccountBalance       :  'Баланс кошелька:',
LIBRE_modalGasPrice             :  'Цена газа:',
LIBRE_modalEstimatedGas         :  'Затраты газа (ожидаемые) :',
LIBRE_modalMaximumGas           :  'Затраты газа (максимальные):',
LIBRE_modalEstimatedTXFee       :  'Комиссия транзакции (ожидаемая):',
LIBRE_modalMaximumTXFee         :  'Комиссия транзакции (максимальная):',
LIBRE_loadingContractData       :  'Загрузка данных контракта...',
LIBRE_exchanger                 :  'Обменник',

LIBRE_errorValidatingRates      :  'Курсы устарели. Запросите расчет снова',
LIBRE_RURCost                   :  'Стоимость обновления (оценка/макс.)',
LIBRE_callbackCost              :  'Цена газа колбэка оракулов',
...
LIBRE_captionApprove            :  'Выдача прав',
LIBRE_captionCalcRates          :  'Расчет курсов',
LIBRE_captionBuyTransaction     :  'Покупка токенов',
LIBRE_captionSellTransaction    :  'Продажа токенов',
...
LIBRE_txState_Fail          :  'неуспех',
LIBRE_txName_updateRates    :  'Запрос курсов',
...
LIBRESTATUS_bankContractAddress  :  'Контракт обменника',
LIBRESTATUS_contractStatus       :  'Статус контракта',
LIBRESTATUS_oraclesStatus        :  'Статус оракулов',
LIBRESTATUS_name                 :  'Имя',
LIBRESTATUS_address              :  'Адрес',
LIBRESTATUS_type                 :  'Тип',
LIBRESTATUS_updateTime           :  'Время обновления',
LIBRESTATUS_rate                 :  'Курс',
