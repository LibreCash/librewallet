...
x_Secalot                   : 'Secalot ',
ADD_Secalot_0a              : 'Re-open LibreBank on a secure (SSL) connection ',
ADD_Secalot_0b              : 'Re-open LibreBank using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
ERROR_35                    : 'Введенный адрес не может быть верифицирован. <a href="https://myetherwallet.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer"> More info</a>', // 35
...
LIBRE_metamaskError         : 'Metamask - транзакция отменена пользователем',
