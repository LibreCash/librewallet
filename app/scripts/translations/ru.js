...
GEN_Help_12                 : 'Используйте его для разблокировки кошелька через LibreBank (или Mist, Geth, Parity или другой кошелек.) ',
...
ADD_MetaMask                : 'Подключиться к MetaMask ',
...
LIBRE_errorValidatingRates      :  'Курсы устарели. Запросите расчте снова',
...
You_can_view_tokens              :  'Вы также можете проверить балан токенов на '
};
