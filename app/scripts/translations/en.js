...
ONBOARD_welcome_content__1      :  'Please take some time to understand this for your own safety. рџ™Џ',
...
ONBOARD_interface_content__6    :  'If you send your *public key (address)* to someone, they can send you ETH or tokens. рџ‘Ќ',
ONBOARD_interface_content__7    :  'If you send your *private key* to someone, they now have full control of your account. рџ‘Ћ',
...
ONBOARD_whymew_content__4       :  'If you don\'t find these things valuable, ask yourself why you think the blockchain and cryptocurrencies are valuable. рџ‰',
...
ONBOARD_final_title__alt        :  'One more click & you\'re done! рџ¤',
...
ONBOARD_resume                  :  'It looks like you didn\'t finish reading through these slides last time. ProTip: Finish reading through the slides рџ‰',

/* Old */
ADD_DigitalBitbox_0a            :  'Re-open LibreBank on a secure (SSL) connection',
ADD_DigitalBitbox_0b            :  'Re-open LibreBank using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/)',
...
ADD_Ledger_0a                   :  'You must access LibreBank via a secure (SSL / HTTPS) connection to connect.',
ADD_Ledger_0b                   :  'Re-open LibreBank using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/)',
...
ERROR_35                        :  '(error_36) Input address is not checksummed. <a href="https://LibreBank.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer">What does that mean?</a>',
...
GETH_GasLimit                   :  '(geth-03) Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://LibreBank.github.io/knowledge-base/gas/what-is-gas-ethereum.html)',
...
GEN_Help_12                     :  'Use it to unlock your wallet via LibreBank (or MEW, Mist, Geth, Parity and other wallet clients.)',
...
GEN_Help_7                      :  'Keep it safe В· Make a backup В· Don\'t share it with anyone В· Don\'t lose it В· It cannot be recovered if you lose it.',
...
MYWAL_Content_3                 :  'If you want to use this wallet with your LibreBank CX in the future, you will need to manually re-add it using the private key/JSON and password.',
MYWAL_Edit                      :  'Edit',
...
LIBRESTATUS_allowed             :  'Exchange allowed',
LIBRESTATUS_status              :  'Contract status',
LIBRESTATUS_lastUpdate          :  'Rate request',
LIBRESTATUS_queuePeriod         :  'Queue time',
LIBRESTATUS_seconds             :  'seconds',
LIBRESTATUS_errorStatus         :  'Failed to receive contract status',
LIBRESTATUS_errorVar            :  'Error getting contract variable(s)',
LIBRE_checkLegit                :  'Please check contracts\' addresses',
LIBRE_sellTokens                :  'Tokens to Sell',
LIBRE_sellAllApproved           :  'Sell all tokens',
LIBRE_exchangeLibreCash         :  'Exchange LibreCash',
LIBRE_sellRate                  :  'Selling rate',
LIBRE_buyRate                   :  'Purchasing rate',
LIBRE_tokenBalance              :  'Balance',
LIBRE_allowed                   :  'Allowed:',
LIBRE_allTokens                 :  'All tokens:',
LIBRE_needApprove               :  'You need to approve some tokens before selling them',
LIBRE_rateProcessing            :  'Receiving rates from oracles...',
LIBRE_oraclesReceived           :  'oracles have received data',
LIBRE_timeout                   :  'Timeout',
LIBRE_remains                   :  'remains',
LIBRE_calculatingPossible       :  'Calculating rates is possible when:',
LIBRE_calculatingPossible1      :  'all oracles data is up-to-date',
LIBRE_calculatingPossible2      :  'or time is out and at least',
LIBRE_calculatingPossible3      :  'oracles received actual data',
LIBRE_oraclesActual             :  'Oracles data is up-to-date. Please start calculation of purchasing and selling rates.',
LIBRE_oraclesActual1            :  'oracles have actual data now. Each oracle\'s data is actual for 10 minutes.',
LIBRE_oraclesActual2            :  'You need at least',
LIBRE_oraclesActual3            :  'actual oracles to calculate rates',
LIBRE_deadline1                 :  'Contract deadline in',
LIBRE_deadline2                 :  '',
LIBRE_allowance                 :  'Approved',
LIBRE_approve                   :  'Authorize',
LIBRE_approve0                  :  'Dismiss',
LIBRE_balance                   :  'Balance',
LIBRE_approveAll                :  'Approve whole balance',
LIBRE_sell                      :  'Sell',
LIBRE_buy                       :  'Buy',
LIBRE_buyDirection              :  'ETH -> Libre',
LIBRE_sellDirection             :  'Libre -> ETH',
LIBRE_noTokens                  :  'No tokens',
LIBRE_contracts                 :  'Contracts',
...
LIBRE_orderAmount               :  'Amount',
LIBRE_orderTimestamp            :  'Timestamp',
LIBRE_orderLimit                :  'Rate Limit',
LIBRE_orderNoOrders             :  'You have no orders',
LIBRE_nullWallet                :  'You are not authorized to the wallet',
LIBRE_stateLOCKED               :  'Locked',
LIBRE_statePROCESSING_ORDERS    :  'Processing orders',
LIBRE_stateWAIT_ORACLES         :  'Waiting for oracles',
LIBRE_stateCALC_RATES           :  'Calculate rates',
LIBRE_stateREQUEST_RATES        :  'Request rates',
LIBRE_whenActual                :  'Rates will be relevant for',
LIBRE_contractBalances          :  'Contract balances',
// do not rename LIBRE*_txOk, LIBRE*_txFail
LIBREALLOWANCE_equal            :  'The amount you\'re trying to approve is already approved',
LIBREALLOWANCE_txOk             :  'Expenditure rights are granted',
LIBREALLOWANCE_txFail           :  'Expenditure rights setting failed',
LIBRESELL_txOk                  :  'Tokens are successfully sold',
LIBRESELL_txFail                :  'Sale transaction failed',
LIBREWITHDRAW_txOk              :  'Withdrawal is successfully processed',
LIBREWITHDRAW_txFail            :  'Withdrawal failed',
LIBREBUY_txOk                   :  'Purchase transaction confirmed',
LIBREBUY_txFail                 :  'Purchase transaction failed',
LIBRERUR_txOk                   :  'Request rates transaction confirmed',
LIBRERUR_txFail                 :  'Request rates transaction failed',
LIBRECR_txOk                    :  'Calc rates transaction confirmed',
LIBRECR_txFail                  :  'Calc rates transaction failed',
LIBREPBUY_txOk                  :  'Purchase queue has been processed',
LIBREPBUY_txFail                :  'Purchase queue processing failed',
LIBREPSELL_txOk                 :  'Sale queue has been processed',
LIBREPSELL_txFail               :  'Sale queue processing failed',
LIBRESEND_txOk                  :  'Successfully sent',
LIBRESEND_txFail                :  'Sending failed',
LIBRE_possibleError             :  'Unknown network error or bank contract error',
LIBRE_gettingDataError          :  'Getting contract data error',
LIBRE_orderNotAllowed           :  'Orders creation is not available at the moment. Please check the contract status.',
LIBRE_RURNotAllowed             :  'Rates request is not available',
LIBRE_CRNotAllowed              :  'Rates calculation is not available',
LIBRE_QueueNotAllowed           :  'Order processing is not available',
LIBRE_bankPaused                :  'LibreBank contract is paused right now',
LIBREBUY_networkFail            :  'Contract works only in the Rinkeby and ETH Mainnet networks!',
LIBRE_forceEmission             :  'Emission and remission',
LIBREFORCE_RUR                  :  'Request Rates',
LIBREFORCE_CR                   :  'Calc Rates',
LIBREFORCE_PBUY                 :  'Process purchase orders (max.5)',
LIBREFORCE_PSELL                :  'Process sale orders (max.5)',
LIBREFE_LBStatus                :  'LibreBank status:',
LIBREFE_LastBlockTime           :  'Last block time:',
LIBREFE_LastUpdate              :  'Last update:',
LIBREFE_RelevancePeriod         :  'Rate relevance period:',
LIBREFE_QueuePeriod             :  'Queue processing period:',
...
LIBRE_modalGasPrice             :  'Gas Price:',
LIBRE_modalEstimatedGas         :  'Estimated Gas:',
LIBRE_modalMaximumGas           :  'Maximum Gas:',
LIBRE_modalEstimatedTXFee       :  'Estimated TX Fee:',
LIBRE_modalMaximumTXFee         :  'Maximum TX Fee:',

LIBRE_loadingContractData       :  'Loading contract data...',
LIBRE_exchanger                 :  'Exchanger',

LIBRE_errorValidatingRates      :  'Error validating rates',
LIBRE_RURCost                   :  'Est./max update rates cost',
LIBRE_callbackCost              :  'Oracles callback gas price',
LIBRE_exchangerLocked           :  'The exchanger is locked. Try again later and write to support@librebank.com',
LIBRE_days                      :  'days',
LIBRE_waiting                   :  'waiting...',
LIBRE_captionUpdateRates        :  'Request Rates',
LIBRE_captionApprove            :  'Set Allowance',
LIBRE_captionCalcRates          :  'Calc Rates',
...
LIBRE_txName_updateRates        :  'Request Rates',
LIBRE_txName_calcRates          :  'Calc Rates',
LIBRE_txName_buy                :  'Buy',
LIBRE_txName_sell               :  'Sell',
LIBRE_txName_approve            :  'Approve',
LIBRE_txName_send               :  'Send',
...
NODE_Warning                    :  'Your node must be HTTPS in order to connect to it via LibreBank.com. You can [download the LibreBank repo & run it locally](https://github.com/kvhnuke/etherwallet/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
...
sidebar_donation                :  'LibreBank is a free, open-source service dedicated to your privacy and security. The more donations we receive, the more time we spend creating new features, listening to your feedback, and giving you what you want. We are just two people trying to change the world. Help us?',
...
tx_FoundOnChain_3               :  '**If you do not see any errors, your transaction was successfully sent.** Your ETH or Tokens are where you sent them. If you cannot see this ETH or Tokens credited in your other wallet / exchange account, and it has been 24+ hours since you sent, please [contact that service](https://LibreBank.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Send them the *link* to your transaction and ask them, nicely, to look into your situation.',
...
VAR_countOracles                :  'Oracles Count',
VAR_requestPrice                :  'Request cost',
VAR_requestTime                 :  'Rate request time',
...
x_Keystore                      :  'File (UTC / JSON)',
x_Keystore2                     :  'File (UTC / JSON)',
x_Balance_only                  :  'View Balance Only',
...
HELP_21_Desc_3                  :  'In this you have a private key and a public key. The private key can derive the public key, but the public key cannot be turned back into the private key. The fact that the internet and the worldвЂ™s secrets are using this cryptography means that if there is a way to go from public key to private key, your lost ether is the least of everyoneвЂ™s problems.',
