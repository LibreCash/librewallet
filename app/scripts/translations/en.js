...
LIBRESTATUS_allowed             :  'Orders allowed',
LIBRESTATUS_status              :  'Bank contract status',
LIBRESTATUS_lastUpdate          :  'Last update request time',
LIBRESTATUS_queuePeriod         :  'Queue processing period',
LIBRESTATUS_seconds             :  'seconds',
LIBRESTATUS_errorStatus         :  'Error getting contract status',
LIBRESTATUS_errorVar            :  'Error getting contract variable(s)',
LIBRE_checkLegit                :  'Please, check contracts legitimity.',
LIBRE_sellTokens                :  'Tokens to Sell',
LIBRE_sellAllApproved           :  'Sell All Available Tokens',
LIBRE_exchangeLibreCash         :  'Exchange LibreCash',
LIBRE_sellRate                  :  'Sell rate',
LIBRE_buyRate                   :  'Buy rate',
...
LIBRE_rateProcessing            :  'Rate information processing from the oracles...',
...
LIBRE_calculatingPossible1      :  'every oracle gets actual data',
LIBRE_calculatingPossible2      :  'or timeout and at least',
LIBRE_calculatingPossible3      :  'oracles get actual data',
LIBRE_oraclesActual             :  'Oracles have actual data. You need to initiate calculating buy and sell rates',
...
LIBRE_approve                   :  'Approve',
LIBRE_approve0                  :  'Approve 0',
...
LIBRE_noTokens                  :  'No tokens on balance',
...
LIBRE_nullWallet                :  'Wallet variable is null',
...
LIBRE_whenActual                :  'Rates are actual for',
...
LIBRESELL_txOk                  :  'The sell transaction confirmed',
LIBRESELL_txFail                :  'The sell transaction failed',
...
LIBRERUR_txOk                   :  'The requestRates transaction confirmed',
LIBRERUR_txFail                 :  'The requestRates transaction failed',
LIBRECR_txOk                    :  'The calcRates transaction confirmed',
LIBRECR_txFail                  :  'The calcRates transaction failed',
LIBREPBUY_txOk                  :  'The process buy orders transaction confirmed',
LIBREPBUY_txFail                :  'The process buy orders transaction failed',
LIBREPSELL_txOk                 :  'The process sell orders transaction confirmed',
LIBREPSELL_txFail               :  'The process sell orders transaction failed',
LIBRE_possibleError             :  'Possible error with network or the bank contract',
...
LIBRE_RURNotAllowed             :  'Request Rates isn\'t allowed now',
LIBRE_CRNotAllowed              :  'Calc Rates isn\'t allowed now',
LIBRE_QueueNotAllowed           :  'Order processing isn\'t allowed now',
LIBRE_bankPaused                :  'LibreBank contract is paused right now',
LIBREBUY_networkFail            :  'Contract works only in the Rinkeby network!',
LIBRE_forceEmission             :  'Force Emission',
LIBREFORCE_RUR                  :  'Update Rates',
LIBREFORCE_CR                   :  'Calc Rates',
LIBREFORCE_PBUY                 :  'Process Buy Orders (max. 5)',
...
LIBREFE_RelevancePeriod         :  'Relevance period:',
