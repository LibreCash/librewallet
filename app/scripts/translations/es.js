...
/* Onboarding */
ONBOARD_welcome_title           :  'Bienvenido a LibreBank.com',
...
ONBOARD_welcome_content__5      :  'LibreBank es una interfaz gratuita, de código abierto, del lado del cliente.',
...
ONBOARD_bank_title              :  'LibreBank no es un banco',
...
ONBOARD_interface_title         :  'LibreBank es una Interfaz',
ONBOARD_interface_content__1    :  'Cuando crea una cuenta en LibreBank está generando un conjunto criptográfico de números: su clave privada y su clave pública (dirección).',
...
ONBOARD_blockchain_content__4   :  'Los bloques en el blockchain se componen de todas las transacciones individuales enviadas desde LibreBank, MetaMask, Exodus, Mist, Geth, Parity y en cualquier otro lugar.',
ONBOARD_blockchain_content__5   :  'Cuando vea su saldo en LibreBank.com o vea sus transacciones en [etherscan.io] (https://etherscan.io), verá datos en la cadena de bloques, no en nuestros sistemas personales.',
...
ONBOARD_whymew_title            :  'Si LibreBank no puede hacer esas cosas, ¿para qyé sirve?',
...
ONBOARD_secure_1_content__1     :  'Phishers le envía un mensaje con un enlace a un sitio web que se parece a LibreBank, EtherDelta, Paypal o a su banco, pero no es el sitio web real. Le roban su información y luego le roban su dinero.',
...
ONBOARD_secure_1_content__3     :  'Siempre revisa la URL: `https://www.LibreBank.com`.',
ONBOARD_secure_1_content__4     :  'Siempre asegúrese de que la barra de URL tenga `LibreBank INC` en verde.',
...
GEN_Help_12                 : 'Úselo para desbloquear su billetera a través de LibreBank (o Mist, Geth, Parity y otros clientes de billetera). ',
...
TXFEE_Desc                  : 'La tarifa de TX se paga a los mineros por incluir su TX en un bloque. Es el `límite de gas` * `precio del gas`. [Puede convertir GWEI -> ETH aquí](https://www.LibreBank.com/helpers.html)',
