...
<header class="{{curNode.name}} {{curNode.service}} {{curNode.service}} nav-index-{{gService.currentTab}} header" aria-label="header" ng-controller='tabsCtrl' >
...
<nav role="navigation" aria-label="main navigation" class="nav-container header-branding overflowing" >
  <a class="nav-toggler"  id="nav-toggler"></a>
  @@if (site === 'mew' ) {
...
<!--   <a aria-hidden="true" ng-show="showLeftArrow" class="nav-arrow-left" ng-click="scrollLeft(100);" ng-mouseover="scrollHoverIn(true,2);" ng-mouseleave="scrollHoverOut()">&#171;</a> -->
  ...
  <div class="nav-scroll nav-scroll--mobile">
    <ul class="nav-inner">
      @@if (site === 'mew' ) {
      <li ng-repeat="tab in tabNames track by $index" \
          class="nav-item {{tab.name}}" \
