  ...
  <section class="row order-panel">
    <div class="col-sm-4 order-info">
      <p class="mono">
        ...
        <span class="text-white">ETH = {{bity.curRate.ETHBTC*priceTicker.ETHBTC | number: 6}} BTC</span>
      </p>
      <p class="mono">
        <input class="form-control input-sm" ng-model="priceTicker.ETHREP"/>
        <span class="text-white">ETH = {{bity.curRate.ETHREP*priceTicker.ETHREP | number: 6}} REP</span>
      </p>
    </div>
    <div class="col-sm-4 order-info">
        <div class="row">
            <div class="col-sm-6">
                <a class="link pull-left-x" href="https://bity.com/af/jshkb37v" target="_blank" rel="noopener noreferrer"><img src="images/logo-bity-white.svg" width="120" height="49" /></a>
            </div>
            <div class="col-sm-6">
                <a class="link pull-right-x" href="https://home.kyber.network/" target="_blank" rel="noopener noreferrer"><img src="images/logo-kyber.svg" width="200" height="111" /></a>
            </div>
        </div>
    </div>
    <div class="col-sm-4 order-info">
      <p class="mono">
        ...
        <span class="text-white">BTC = {{bity.curRate.BTCETH*priceTicker.BTCETH | number: 6}} ETH</span>
      </p>
      <p class="mono">
        <input class="form-control input-sm" ng-model="priceTicker.BTCREP"/>
        <span class="text-white">BTC = {{bity.curRate.BTCREP*priceTicker.BTCREP | number: 6}} REP</span>
      </p>
    </div>
...
<article class="swap-panel block clearfix" ng-show="showStage1">
  ...
  <h1 translate="SWAP_init_2" class="for-block"> for </h1>
