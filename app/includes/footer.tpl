<section class="pre-footer">
  <div class="container">
    <p>
      LibreBank does not hold your keys for you. We cannot access accounts, recover keys, reset passwords, nor reverse transactions. Protect your keys &amp; always check that you are on correct URL.
...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--left">
      ...
      <a href="/"><img src="images/logo-libre.svg" height="45px" width="auto" alt="LibreWallet" class="footer--logo"/></a>

      <p>
        <span translate="FOOTER_1">
          Free, open-source, client-side interface for generating Ethereum wallets &amp; more. Interact with the Ethereum blockchain easily &amp; securely. Double-check the URL ( librebank.com ) before unlocking your wallet.
        </span>
      </p>
      ...
      <p>
        &copy; 2018 LibreWallet (based on MyEtherWallet), LLC
      </p>
    ...
    <section class="footer--righ">
      ...
      <p>
          <a aria-label="LibreBank Page" href="https://www.librebank.com" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
            LibreBank Page
          </a>
        </p>
  
        <p>
          <a href="https://www.librecash.com/" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
            LibreCash Page
          </a>
        </p>
  
        <p>
          <a href="https://www.blog.libre.live" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
            Our Blog
          </a>
        </p>
